<template>
          ...
          <v-card-text>
            ...
            <template v-if="selectedOption && selectedOption.value === 1">
              ...
              <v-row>
                ...
                <v-btn
                  ...
                  color="primary"
                  dark
                  @click="payWithCredit(valorRandom)"
                  >PAGAR</v-btn
                >
              </v-row>
              <v-text-field
            ...
            <template v-if="selectedOption && selectedOption.value === 3">
              ...
              <v-btn
                ...
                rounded
                dark
                @click="payWithPix(valorRandom, 2)"
                >PAGAR</v-btn
              >
            </template>
          </v-card-text>
          <v-card-actions>
            <v-btn color="primary" rounded text @click="closeDialog()"
              >Fechar</v-btn
            >
          </v-card-actions>
        </v-card>
      ...
      <v-dialog v-model="NoLogin" persistent width="500">
        <v-card>
          <v-card-title
            ><v-icon color="primary" size="18" @click="NoLogin = false"
              >mdi-close</v-icon
            ></v-card-title
          >
          <v-container>
            <v-col class="align-center justify-center">
              <v-card-text class="text-center">
                <h2 class="primary--text">
                  Você não está logado, entre com sua conta!
                </h2>
                <v-spacer></v-spacer>
                <v-container>
                  <v-btn block             min-height="40"  color="primary" to="/login"
                    >ENTRAR</v-btn
                  >
                </v-container>
              </v-card-text>
      ...
      <v-dialog v-model="dialogPaymentMethod" width="500">
        <v-card rounded>
          <v-card-title class="primary--text">
            <v-icon color="primary" @click="dialogPaymentMethod = false"
              >mdi-close</v-icon
            >
            &nbsp;Forma de pagamento
          </v-card-title>
          <v-card-text>
            <p class="caption">
              Você está contribuindo com uma meta da sua criadora
            </p>
            <v-expansion-panels>
              <v-expansion-panel>
                <v-expansion-panel-header>
                ...
                <v-expansion-panel-content>
                  <v-form
                    ...
                    <v-btn
                      ...
                      dark
                      rounded
                      @click="payWithPix(valorContribuicao, 1)"
                      >PAGAR</v-btn
                    >
                  </v-form>
                </v-expansion-panel-content>
        ...
        <div class="d-flex justify-center align-center">
          <v-card dark rounded>
            <v-container v-if="paymentSuccessForm === false">
              <v-card-text class="text-center">
                <v-row align="center" justify="center">
                  ...
                  <v-col
                    cols="12"
                    class="d-flex align-center justify-center text-center mt-n2"
                  >
            ...
            <v-container v-else class="d-flex justify-center align-center">
              <h3 class="primary--text text-center mb-2">
                Pagamento realizado com sucesso!
              </h3>
              <v-row align="center" justify="center">
                <v-col
                  cols="12"
                  class="d-flex align-center justify-center text-center mt-2"
                >
      ...
      <v-snackbar v-model="snackbackShow" :color="snackbackShowColor" timeout="3000" centered rounded="pill">{{ snackbarShowText }}</v-snackbar>
  </template>
