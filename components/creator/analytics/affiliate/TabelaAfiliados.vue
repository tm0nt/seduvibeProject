        ...
        <v-row align="center" justify="center">
          <v-col cols="12" sm="6">
            ...
            <v-card color="input_color" class="rounded-xl mx-2" flat>
                ...
                <v-card-title class="text-caption text-medium-emphasis">Pedidos de afiliação</v-card-title>
            ...
            >
              <template v-slot:[`item.actions`]="{ item }">
                <v-btn
                  ...
                  dark
                  x-small
                  @click="dialogActiveAffiliate(item)"
                >
              ...
              <template v-slot:no-data>
                <div class="px-4" v-if="!loading">
                  ...
                  <v-icon color="grey" @click="reloadActiveAffiliate"
                    >mdi-reload</v-icon
                  >
                </div>
      ...
      <v-dialog v-model="dialogDelete" max-width="400" dark>
        <v-card>
          <v-card-title class="headline"
            >Deseja remover este usuário?</v-card-title
          >
          <v-card-actions>
            <v-spacer></v-spacer>
      ...
      <v-dialog v-model="dialogActiveAffiliateList" width="400">
        <v-card dark>
          <v-card-title class="purple--text">
            <v-icon @click="dialogActiveAffiliateList = false" color="purple"
              >mdi-close</v-icon
          ...
          <v-card-actions>
            <v-btn
              text
              color="purple"
              @click="deleteAffiliate(ActiveAffiliateListData.user.id)"
