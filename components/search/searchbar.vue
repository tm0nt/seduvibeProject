<template>
  <v-container fluid>
    ...
    <v-card
      ...
      height="auto"
      :class="{ 'scrollable-card': filteredUsers.length >= 5 }"
      class="overflow-y rounded-xl elevation-0 mt-2"
      flat
    >
          ...
          <v-card class="mb-1 elevation-0 transparent" flat width="">
            <router-link :to="{ path: `/@${user.user}` }" style="text-decoration: none">
              <v-row align="center" justify="center">
                ...
                <v-col cols="9">
                  <v-card-title class="text-h6 font-weight-light purple--text"> oi </v-card-title>
